// app/components/ProductCardServer.tsx - Server-side version for ISR
...
// Star rating component (server-side safe)
...
// Stock indicator component (server-side safe)
...
export default function ProductCardServer({
    ...
    return (
        <div className={`group rounded-2xl overflow-hidden bg-white/95 backdrop-blur-sm shadow-lg hover:shadow-2xl transition-all duration-500 border border-[#c1a5a2]/20 hover:border-[#9a6a63]/40 transform hover:-translate-y-2 ${className} cursor-pointer flex flex-col h-full ${product.stock === 0 ? 'opacity-75' : ''}`}>
            {/* Image Section */}
            <div className="relative aspect-[3/4] overflow-hidden">
                <Image
                    src={product.image || `/placeholder-${product.typeRef?.toLowerCase() || 'product'}.jpg`}
                    alt={product.name}
                    fill
            ...
            <div className="p-5 flex flex-col flex-1">
                ...
                {/* Price and View Product - Push to bottom */}
                <div className="flex items-center justify-between mt-auto">
                    ...
                    <div className="px-4 py-2 text-white rounded-xl transition-all transform shadow-lg font-medium text-sm"
